...
import TaksChild from './components/TaksChild.vue';
const tarefas = ref([
...
<template>
  <div class="container">
    ...
    <ul>
      <TaksChild v-for="tarefa in tarefasFiltradas" :key="tarefa.id" :id="tarefa.id" :descricao="tarefa.desc" :status="tarefa.status" @excluir="deleteTarefa" @editar="editarTarefa">
